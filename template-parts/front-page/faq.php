...
?>
<!-- FAQ Section -->
<section id="faq" class="py-20 bg-brand-beige">
    <div class="container mx-auto px-4">
        <div class="text-center max-w-3xl mx-auto mb-16">
            <span class="inline-block text-brand-purple font-bold tracking-wider uppercase text-sm mb-2"><?php esc_html_e('FAQ', 'natpatoune'); ?></span>
            <h2 class="font-title font-bold text-3xl md:text-4xl text-brand-text mb-4"><?php esc_html_e('Questions fréquentes', 'natpatoune'); ?></h2>
            <p class="text-lg text-brand-text-light"><?php esc_html_e('Vous avez des questions ? Voici les réponses aux interrogations les plus courantes sur mes services de garde de chats.', 'natpatoune'); ?></p>
        </div>
        ...
        <div class="max-w-3xl mx-auto space-y-4">
            ...
            <div class="bg-white rounded-2xl shadow-soft overflow-hidden">
                <button class="accordion-trigger w-full flex items-center justify-between p-6 text-left focus:outline-none group" aria-expanded="false" aria-controls="faq-1">
                    <h3 class="font-title font-bold text-lg text-brand-text group-hover:text-brand-purple transition-colors">
                ...
                <div id="faq-1" class="accordion-content hidden border-t border-brand-grey/30">
                    <div class="p-6 bg-brand-cream/50 text-brand-text-light">
                        <p class="mb-3">
            ...
            <!-- FAQ 2 -->
            <div class="bg-white rounded-2xl shadow-soft overflow-hidden">
                <button class="accordion-trigger w-full flex items-center justify-between p-6 text-left focus:outline-none group" aria-expanded="false" aria-controls="faq-2">
                    <h3 class="font-title font-bold text-lg text-brand-text group-hover:text-brand-purple transition-colors">
                ...
                <div id="faq-2" class="accordion-content hidden border-t border-brand-grey/30">
                    <div class="p-6 bg-brand-cream/50 text-brand-text-light">
                        <p>
            ...
            <!-- FAQ 3 -->
            <div class="bg-white rounded-2xl shadow-soft overflow-hidden">
                <button class="accordion-trigger w-full flex items-center justify-between p-6 text-left focus:outline-none group" aria-expanded="false" aria-controls="faq-3">
                    <h3 class="font-title font-bold text-lg text-brand-text group-hover:text-brand-purple transition-colors">
                ...
                <div id="faq-3" class="accordion-content hidden border-t border-brand-grey/30">
                    <div class="p-6 bg-brand-cream/50 text-brand-text-light">
                        <p>
            ...
            <!-- FAQ 4 -->
            <div class="bg-white rounded-2xl shadow-soft overflow-hidden">
                <button class="accordion-trigger w-full flex items-center justify-between p-6 text-left focus:outline-none group" aria-expanded="false" aria-controls="faq-4">
                    <h3 class="font-title font-bold text-lg text-brand-text group-hover:text-brand-purple transition-colors">
                ...
                <div id="faq-4" class="accordion-content hidden border-t border-brand-grey/30">
                    <div class="p-6 bg-brand-cream/50 text-brand-text-light">
                        <p>
            ...
            <!-- FAQ 5 -->
            <div class="bg-white rounded-2xl shadow-soft overflow-hidden">
                <button class="accordion-trigger w-full flex items-center justify-between p-6 text-left focus:outline-none group" aria-expanded="false" aria-controls="faq-5">
                    <h3 class="font-title font-bold text-lg text-brand-text group-hover:text-brand-purple transition-colors">
                ...
                <div id="faq-5" class="accordion-content hidden border-t border-brand-grey/30">
                    <div class="p-6 bg-brand-cream/50 text-brand-text-light">
                        <p class="mb-3">
            ...
            <!-- FAQ 6 -->
            <div class="bg-white rounded-2xl shadow-soft overflow-hidden">
                <button class="accordion-trigger w-full flex items-center justify-between p-6 text-left focus:outline-none group" aria-expanded="false" aria-controls="faq-6">
                    <h3 class="font-title font-bold text-lg text-brand-text group-hover:text-brand-purple transition-colors">
                ...
                <div id="faq-6" class="accordion-content hidden border-t border-brand-grey/30">
                    <div class="p-6 bg-brand-cream/50 text-brand-text-light">
                        <p>
            ...
            <!-- FAQ 7 -->
            <div class="bg-white rounded-2xl shadow-soft overflow-hidden">
                <button class="accordion-trigger w-full flex items-center justify-between p-6 text-left focus:outline-none group" aria-expanded="false" aria-controls="faq-7">
                    <h3 class="font-title font-bold text-lg text-brand-text group-hover:text-brand-purple transition-colors">
                ...
                <div id="faq-7" class="accordion-content hidden border-t border-brand-grey/30">
                    <div class="p-6 bg-brand-cream/50 text-brand-text-light">
                        <p>
            ...
            <!-- FAQ 8 -->
            <div class="bg-white rounded-2xl shadow-soft overflow-hidden">
                <button class="accordion-trigger w-full flex items-center justify-between p-6 text-left focus:outline-none group" aria-expanded="false" aria-controls="faq-8">
                    <h3 class="font-title font-bold text-lg text-brand-text group-hover:text-brand-purple transition-colors">
                ...
                <div id="faq-8" class="accordion-content hidden border-t border-brand-grey/30">
                    <div class="p-6 bg-brand-cream/50 text-brand-text-light">
                        <p>
        ...
        <div class="text-center mt-16">
            <p class="text-lg text-brand-text-light mb-6">
